...
void main() {
  group('DummyCommandableLambdaFunction', () {
    ...
    test('CRUD Operations', () async {
      ...
      // Create one dummy
      var result = await lambda.act({'cmd': 'create_dummy', 'dummy': DUMMY1.toJson()});
      ...
      result = await lambda.act({'cmd': 'create_dummy', 'dummy': DUMMY2.toJson()});
      ...
      result = await lambda.act({'cmd': 'update_dummy', 'dummy': dummy1.toJson()});
      dummy = Dummy.fromJson(json.decode(result));
      expect(dummy, isNotNull);
